...
func TestService(t *testing.T) {
	...
	bad := testdata.InsertLLM(rt, testdata.Org1, "c69723d8-fb37-4cf6-9ec4-bc40cb36f2cc", "google", "gemini", "Bad Config", map[string]any{})
	good := testdata.InsertLLM(rt, testdata.Org1, "b86966fd-206e-4bdd-a962-06faa3af1182", "google", "gemini", "Good", map[string]any{"api_key": "sesame"})
	models.FlushCache()
