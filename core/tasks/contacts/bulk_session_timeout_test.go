...
func TestBulkSessionTimeout(t *testing.T) {
	...
	testsuite.AssertContactTasks(t, testdata.Org1, testdata.Cathy, []string{
		`{"type":"timeout_event","task":{"session_uuid":"8e2786dc-e6d0-4a6a-bbc5-4ec321d60516","sprint_uuid":"babdfd9e-241d-4d32-be5f-d821d1ecab31"},"queued_on":"2024-11-15T13:59:00Z"}`,
	})
	testsuite.AssertContactTasks(t, testdata.Org1, testdata.Bob, []string{
		`{"type":"timeout_event","task":{"session_uuid":"b38dcb5b-9475-423d-a6bf-253b35831f4b","sprint_uuid":"c4d1fcc0-ca3f-4b7e-8184-804d039a3d23"},"queued_on":"2024-11-15T13:59:00Z"}`,
	})
}
