...
func TestBulkSessionExpire(t *testing.T) {
	...
	testsuite.AssertContactTasks(t, testdata.Org1, testdata.Bob, []string{
		`{"type":"wait_expired","task":{"session_uuid":"b38dcb5b-9475-423d-a6bf-253b35831f4b","sprint_uuid":"c4d1fcc0-ca3f-4b7e-8184-804d039a3d23"},"queued_on":"2024-11-15T13:59:00Z"}`,
	})
}
