...
var UpdateContactStatus models.SceneCommitHook = &updateContactStatus{}

type updateContactStatus struct{}

func (h *updateContactStatus) Order() int { return 1 }

func (h *updateContactStatus) Apply(ctx context.Context, rt *runtime.Runtime, tx *sqlx.Tx, oa *models.OrgAssets, scenes map[*models.Scene][]any) error {
