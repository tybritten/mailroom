...
func handleMsgReceived(ctx context.Context, rt *runtime.Runtime, oa *models.OrgAssets, scene *models.Scene, e flows.Event) error {
	...
	scene.AttachPreCommitHook(hooks.ContactLastSeenHook, event)
