...
func handleResthookCalled(ctx context.Context, rt *runtime.Runtime, oa *models.OrgAssets, scene *models.Scene, e flows.Event) error {
	...
	scene.AttachPreCommitHook(hooks.InsertWebhookEventHook, re)
