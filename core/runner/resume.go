...
func ResumeFlow(ctx context.Context, rt *runtime.Runtime, oa *models.OrgAssets, session *models.Session, contact *models.Contact, resume flows.Resume, call *models.Call, incomingMsgID models.MsgID, hook models.SessionCommitHook) (*models.Session, error) {
	start := time.Now()
	sa := oa.SessionAssets()
	...
	if err := ApplyPostCommitHooks(ctx, rt, oa, []*Scene{scene}); err != nil {
